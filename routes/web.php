...
Route::middleware(['akses:siswa,pengelola,peminta'])->group(function () {
    ...
    Route::get('/perencanaan/cetak', [PerencanaanController::class, 'cetak']);
...
Route::middleware(['akses:peminta,pengelola'])->group(function () {
    ...
    Route::get('/pengajuan/cetak', [PengajuanController::class, 'cetak']);
    Route::get('/pengajuan/cetakDetail/{id}', [PengajuanController::class, 'cetakDetail']);
