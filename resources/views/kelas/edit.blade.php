...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">EDIT DATA KELAS</h1>
                      ...
                      <div class="form-group mb-3">
                        ...
                        <select name="id_angkatan" id="angkatan" class="form-select form-control">
                            ...
                            <option value="{{ $a->id_angkatan }}"
                                {{ $a->id_angkatan == $a->id_angkatan ? 'selected' : '' }}>
                                {{ $a->no_angkatan }}
                            @endforeach
                        </select>
                      <div class="form-group mb-3">
                        ...
                        <select name="id_jurusan" id="jurusan" class="form-select form-control">
                            ...
                            <option value="{{ $j->id_jurusan }}"
                                {{ $j->id_jurusan == $j->id_jurusan ? 'selected' : '' }}>
                                {{ $j->nama_jurusan }}
                            @endforeach
                        </select>
