...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA JABATAN PENGELOLA</h1>
            ...
            <form action="tambah/simpan" method="POST">
                <div class="form">
                    <div class="form-group mb-3">
                        <label for="nama_jabatan" style="color: #E6B31E;">Nama Jabatan Pengelola</label>
