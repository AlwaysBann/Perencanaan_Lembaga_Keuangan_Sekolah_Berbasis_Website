...
@section('content')
    ...
    <body>
        <div class="px-5 py-3">
            <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">DATA JABATAN PEMINTA
            </h1>
                            ...
                            @foreach ($jabatan as $j)
                                <tr>
                                    ...
                                    <td style="max-width: 40px">
                                        <a href="jabatan_peminta/edit/{{ $j->id_jabatan_peminta }}" class="btn mx-4"
                                        ...
                                        <btn class="btn btnHapus mx-2"
                                            ...
                                            idJabatan="{{ $j->id_jabatan_peminta }}">HAPUS</btn>
                                    </td>
                                </tr>
                        </tbody>
                        @endforeach
