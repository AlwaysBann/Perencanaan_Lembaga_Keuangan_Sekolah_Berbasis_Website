            ...
            <form action="tambah/simpan" method="POST" enctype="multipart/form-data">
                <div class="form">
                    <div class="form-group mb-3">
                      ...
                      <select name="username" id="username" class="form-select form-control">
                          @foreach ($siswa as $s)
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" placeholder="Masukan Nama Siswa">
                        @csrf
                      </div>
                      <div class="form-group mb-3">
                      ...
                      <select name="id_kelas" id="id_kelas" class="form-select form-control">
                          ...
                          <option value="{{$s->id_kelas}}">{{$s->id_kelas}}</option>
                          @endforeach
                      </select>
