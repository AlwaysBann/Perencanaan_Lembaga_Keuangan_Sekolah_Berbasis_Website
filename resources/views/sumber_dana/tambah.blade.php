...
@section('content')
    ...
    <body>
        <div class="px-5 py-3">
            <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA SUMBER
                DANA</h1>
                        ...
                        <div class="form">
                            <div class="form-group mb-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="id_kelola_keuangan" id="" class="form-select form-control">
                                        @foreach ($kelola as $item)
                                            <option value="" disabled hidden selected>Pilih Kelola Keuangan</option>
                                            <option value="{{ $item->id_kelola_keuangan }}">{{ $item->id_kelola_keuangan }}
                                                - {{ $item->tipe }}
                                            </option>
                                        @endforeach
                                        </option>
