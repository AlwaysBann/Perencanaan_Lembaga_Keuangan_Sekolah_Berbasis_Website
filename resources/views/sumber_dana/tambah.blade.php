...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA SUMBER DANA</h1>
            ...
            <form action="tambah/simpan" method="POST">
                <div class="form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="dana_sumber_dana" name="dana_sumber_dana" placeholder="Dana Sumber Dana" style="margin-bottom: 300px" value="Rp.">
                        @csrf
                      </div>  
