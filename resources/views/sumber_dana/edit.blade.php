...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">EDIT DATA SUMBER DANA</h1>
            ...
            <form action="simpan" method="POST">
                <div class="form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_sumber_dana" name="nama_sumber_dana" placeholder="Nama Sumber Dana"
                         value="{{$sumber_dana->nama_sumber_dana}}">
                        @csrf
                      </div>
                    <div class="form-group mb-3">
                        <label for="dana_sumber_dana" style="color: #E6B31E;">Dana Sumber Dana</label>
                        <input type="text" class="form-control" id="dana_sumber_dana" name="dana_sumber_dana" placeholder="Dana Sumber Dana"
                         value="{{$sumber_dana->dana_sumber_dana}}">
                        @csrf
                      </div>
