        ...
        <nav class="navbar fixed-top navbar-expand-md px-5" style="background-color: #343434; z-index: 100;">
            ...
            @if (Auth::User()->role == 'pengelola')
                ...
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle navbar-brand" style="color: #E6B31E" href="#"
                        id="listDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        DATA MASTER
                    </a>
                    <div class="dropdown-menu mt-1 p-1" aria-labelledby="listDropdown"
                        style="background-color: #343434;z-index: 0">
                        <a href="/ruangan" class="navbar-brand" style="color: #E6B31E; padding-right:50%">RUANGAN</a>
                        <a href="/jabatan_pengelola" class="navbar-brand"
                            style="color: #E6B31E; padding-right:50%">JABATAN PENGELOLA</a>
                        <a href="/pengelola" class="navbar-brand"
                            style="color: #E6B31E; padding-right:50%">PENGELOLA</a>
                        <a href="/jabatan_peminta" class="navbar-brand"
                            style="color: #E6B31E; padding-right:50%">JABATAN PEMINTA</a>
                        ...
                        <a href="/JenisTagihan" class="navbar-brand" style="color: #E6B31E; padding-right:50%">JENIS
                            TAGIHAN</a>
                        <a href="/tagihan" class="navbar-brand" style="color: #E6B31E; padding-right:50%">TAGIHAN</a>
                        <a href="/sumber_dana" class="navbar-brand" style="color: #E6B31E; padding-right:50%">SUMBER
                            DANA</a>
                    </div>
                </div>
