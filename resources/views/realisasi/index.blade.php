            ...
            <div class="card-body" style="margin-top: 200px">
                <div class="d-flex" style="margin-bottom: 20px">
                    ...
                    @if (Auth::check() && Auth::User()->role == 'pengelola')
                        <a href="realisasi/cetak" class="btn btn-info rounded-pill ms-auto"
                            style="color: white; min-width: 130px">
                            Cetak List Data
                        </a>
                        <a href="/realisasi/logs" class="btn btn-warning rounded-pill ms-4"
                            style="color: white; min-width: 130px">
                            Log Activity
                        </a>
                    @endif
                        ...
                        <tbody>
                            @foreach ($realisasi as $r)
                                <tr>
                                    ...
                                    @if ((Auth::check() && Auth::User()->role == 'siswa') || Auth::User()->role == 'peminta')
                                        <td style="max-width: 200px">
                                            <button class="btn mx-2"
                                                ...
                                                disabled>
                                                <a href="realisasi/edit/{{ $r->id_realisasi }}"
                                                    style="color: green; text-decoration: none">EDIT</a>
                                            </button>
                                            <button class="btn mx-2"
                                                style="background-color: white;font-weight: 600 ; border: 1px solid #E6B31E; min-width: 80px;"
                                                disabled>
                                                <a href="realisasi/detail/{{ $r->id_realisasi }}"
                                    ...
                                    @if (Auth::check() && Auth::User()->role == 'pengelola')
                                        <td style="max-width: 200px">
                                            <a href="realisasi/edit/{{ $r->id_realisasi }}" class="btn mx-2"
                                                style="background-color: white;font-weight: 600 ; color: green; border: 1px solid #E6B31E; min-width: 80px;">
                                                EDIT
                                            </a>
                                            <a href="realisasi/detail/{{ $r->id_realisasi }}" class="btn mx-2"
                                                style="background-color: white;font-weight: 600 ; color: #E6B31E; border: 1px solid #E6B31E; min-width: 80px;">
                                                DETAIL
                                            </a>
                                            <btn class="btn btnHapus mx-2"
                                                style="background-color: white;font-weight: 600 ; color: red;  border: 1px solid #E6B31E; min-width: 80px;"
                                                idRealisasi="{{ $r->id_realisasi }}">HAPUS</btn>
                                        </td>
                                    @endif
                                </tr>
                            @endforeach
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.success) {
                                swal.fire('Data ' + idRealisasi + ' Berhasil di hapus!', '',
