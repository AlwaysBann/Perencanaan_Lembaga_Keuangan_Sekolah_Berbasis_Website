...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">EDIT DATA PERENCANAAN</h1>
        ...
        <div class="container my-5 d-flex justify-content-center">
            ...
            @csrf
                <div class="form">
                    <input type="hidden" class="form-control" id="id_pengajuan" name="id_pengajuan" value="{{$perencanaan->id_pengajuan}}">
                    <input type="hidden" class="form-control" id="id_perencanaan" name="id_perencanaan" value="{{$perencanaan->id_perencanaan}}">
                    {{-- <input type="hidden" class="form-control" id="id_pengajuan" name="id_pengajuan" placeholder="Nama Pengaju" value="{{$pengajuan->id_pengajuan}}"> --}}
                      <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_perencanaan" name="nama_perencanaan" placeholder="Nama Perencanaan" value="{{$perencanaan->nama_perencanaan}}">
                       </div>
                       <div class="form-group mb-3">
                        <label for="nama_penganggung_jawab" style="color: #E6B31E;">Nama Penanggung Jawab</label>
                        <input type="text" class="form-control" id="nama_penanggung_jawab" name="nama_penanggung_jawab" placeholder="Nama Penanggung Jawab" value="{{$perencanaan->nama_penanggung_jawab}}">
                       </div>
                      <div class="form-group mb-3">
                        <label for="waktu_realisasi" style="color: #E6B31E;">Waktu Realisasi</label>
                        <input type="date" class="form-control" id="waktu_realisasi" name="waktu_realisasi" placeholder="Waktu Realisasi" value="{{$perencanaan->waktu_realisasi}}">
                       </div>
