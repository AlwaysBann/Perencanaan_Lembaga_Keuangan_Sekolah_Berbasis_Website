...
@section('content')
    ...
    <body>
        <div class="px-5 py-3">
            <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">Profile Peminta
            </h1>
                        ...
                        <div class="col-4">
                            ...
                            <div class="row text-center">
                                <div class="col my-2"
                                    ...
                                    Nama Akun</div>
                                <p class="fs-5 text-white">{{ $peminta->username }}</p>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row">
                                <div class="col"
                                    style="font-family: Nunito; font-size: 20px; font-style: normal; font-weight: 400; color: #E6B31E;">
                                    Nama peminta</div>
                                <p class="fs-5 text-white">{{ $peminta->nama_peminta }}</p>
                            ...
                            <div class="row">
                                <div class="col"
                                    style="font-family: Nunito; font-size: 20px; font-style: normal; font-weight: 400; color: #E6B31E;">
                                    Mulai Jabatan</div>
                                <p class="fs-5 text-white">{{ $peminta->mulai_jabat }}</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="row">
                                <div class="col"
                                    style="font-family: Nunito; font-size: 20px; font-style: normal; font-weight: 400; color: #E6B31E;">
                                    Jabatan peminta</div>
                                <p class="fs-5 text-white">{{ $peminta->nama_jabatan_peminta }}</p>
                            </div>
                            <div class="row">
                                <div class="col"
                                    style="font-family: Nunito; font-size: 20px; font-style: normal; font-weight: 400; color: #E6B31E;">
                                    Akhir Jabatan</div>
                                <p class="fs-5 text-white">{{ $peminta->akhir_jabat }}</p>
                            </div>
                        </div>
                    </div>
                </div>
