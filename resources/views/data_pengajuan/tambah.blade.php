...
@section('content')
    ...
    <body>
        <div class="px-5 py-3">
            <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA PENGAJUAN
            </h1>
            @include('layout.flash-massage')
            <div class="container my-5 d-flex justify-content-center">
                <div class="row rounded-3 p-4" style="background-color: rgba(32, 32, 32, 0.637); min-width: 1000px">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="harga_satuan" name="harga_satuan"
                                        placeholder="Harga Satuan" value="Rp.">
                                </div>
                                <div class="form-group" style="margin-bottom: 30px">
                                    ...
                                    <img id="pic" height="100px" class="my-2">
                                </div>
                            </div>
                        </div>
