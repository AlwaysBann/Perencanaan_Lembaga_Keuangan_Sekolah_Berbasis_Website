...
@section('content')
    ...
    <body>
        <div class="px-5 py-3">
            <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">DATA JENIS TAGIHAN
            </h1>
                            ...
                            @foreach ($JenisTagihan as $JenisTagihan)
                                <tr>
                                    ...
                                    <td style="max-width: 60px">
                                        <a href="JenisTagihan/edit/{{ $JenisTagihan->id_jenis_tagihan }}" class="btn mx-4"
                                        ...
                                        <btn class="btn btnHapus mx-2"
                                            ...
                                            idJenisTagihan="{{ $JenisTagihan->id_jenis_tagihan }}">HAPUS</btn>
                                    </td>
                                </tr>
                        </tbody>
                        @endforeach
