...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA JURUSAN</h1>
            ...
            <form action="tambah/simpan" method="POST">
                <div class="form">
                    <div class="form-group mb-3">
                        <label for="nama_jurusan" style="color: #E6B31E;">Nama Jurusan</label>
                        <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" placeholder="Nama Jurusan" style="margin-bottom: 300px">
                        @csrf
                      </div>
