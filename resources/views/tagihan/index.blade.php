        ...
        <div class="px-5 py-3">
            ...
            <div class="card-body" style="margin-top: 200px">
                <div class="d-flex" style="margin-bottom: 20px">
                    ...
                    <a href="tagihan/logs" class="btn btn-warning rounded-pill ms-auto"
                        ...
                        <tbody>
                            @foreach ($tagihan as $t)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($t->tanggal_tagihan)->format('Y-m') }}</td>
                                    </td>
                                    <td style="max-width: 110px">
                                        <a href="tagihan/edit/{{ $t->id_tagihan }}" class="btn mx-4"
                                        ...
                                        <btn class="btn btnHapus mx-2"
                                            ...
                                            idTagihan="{{ $t->id_tagihan }}">HAPUS</btn>
                                    </td>
                                </tr>
                            @endforeach
