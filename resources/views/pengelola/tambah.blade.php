...
<body>
    <div class="px-5 py-3">
        <h1 class="" style="color: #E6B31E; text-shadow: 0px 0px 2px white; font-weight: 900;">TAMBAH DATA PENGELOLA</h1>
                ...
                <div class="form">
                    <div class="form-group mb-3">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_pengelola" name="nama_pengelola" placeholder="Nama Lengkap Pengelola">
                    </div>
                    <div class="form-group mb-3">
                      ...
                      <select name="id_jabatan_pengelola" id="jabatan_pengelola" class="form-select form-control" >
                          ...
                          <option value="{{$j->id_jabatan_pengelola}}">{{$j->nama_jabatan_pengelola}}</option>
                          @endforeach
                      </select>
                     </div>
                      <div class="form-group mb-3">
